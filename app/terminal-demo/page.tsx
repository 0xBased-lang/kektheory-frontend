 ...
 * Terminal Demo Page
 *
 * Demonstrates the terminal UI components with sample data
    ...
    <TerminalLayout
      topBar={
        <TerminalTopBar
          ...
          navigation={[
            { id: 'marketplace', label: 'Marketplace', active: true, onClick: () => {} },
            { id: 'portfolio', label: 'Portfolio', onClick: () => {} },
            { id: 'rewards', label: 'Rewards', onClick: () => {} }
          ]}
